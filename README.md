...
## Статус разработки (17.05.2025, последнее обновление 14:00)
...
**Проблема:** При попытке выбора элемента на странице возникала ошибка "Could not establish connection. Receiving end does not exist." и элементы не выделялись.
